  ...
  const testimonials = [
    {
      ...
      content: "I used to smoke in the company with my friends. I never thought that it will lead to Cancer. But when I was diagnosed with Cancer, I was shocked. I didn't know what to do. But then i found out about Oxxy and thanks for taking care of me completely.",
      image: "women1.png"
    },
    {
